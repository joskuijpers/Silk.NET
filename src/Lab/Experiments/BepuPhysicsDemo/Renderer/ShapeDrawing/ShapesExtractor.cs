...
namespace DemoRenderer.ShapeDrawing
{
    ...
    public class ShapesExtractor(GL gl, ParallelLooper looper, BufferPool pool, int initialCapacityPerShapeType = 1024)
        : IDisposable
    {
        public ShapeCache ShapeCache = new(initialCapacityPerShapeType, pool);

        public MeshCache MeshCache = new(gl, pool);
