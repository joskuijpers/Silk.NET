...
namespace Demos
{
    public class DemoHarness : IDisposable
    {
        ...
        internal void TryChangeToDemo(int demoIndex)
        {
            ...
            {
                demo.Dispose();
                demo = demoSet.Build(demoIndex, content, loop.Camera, loop.GL);
        ...
        public DemoHarness(GL gl, GameLoop loop, ContentArchive content,
            Controls? controls = null)
        {
            ...
            demoSet = new DemoSet();
            demo = demoSet.Build(0, content, loop.Camera, loop.GL);
