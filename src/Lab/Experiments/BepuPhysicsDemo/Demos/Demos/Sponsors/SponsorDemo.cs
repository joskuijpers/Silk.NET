...
namespace Demos.Demos.Sponsors
{
    ...
    public class SponsorDemo : Demo
    {
        ...
        RenderableImage CreateRewardImage(string rewardImagePath, ContentArchive content, GL gl)
        {
        ...
        void Add(List<Sponsor> sponsors, string name, string rewardImagePath, ContentArchive content, GL gl)
        {
            Sponsor sponsor;
            sponsor.RewardImage = CreateRewardImage(rewardImagePath, content, gl);
            sponsor.Name = name;
            sponsors.Add(sponsor);

        }
        public override void LoadGraphicalContent(ContentArchive content, GL gl)
        {
            ...
            Add(sponsors1, "Y. V.", @"Content\Sponsors\smugturt.png", content, gl);
            Add(sponsors1, "R. S. K.", @"Content\Sponsors\squidhanginout.png", content, gl);
            Add(sponsors1, "Gavin-Williams", @"Content\Sponsors\angerybite.png", content, gl);
            Add(sponsors1, "N.", @"Content\Sponsors\normalgiraffe.png", content, gl);
            Add(sponsors1, "M. H.", @"Content\Sponsors\tarbeenus.png", content, gl);
            Add(sponsors1, "K. C.", @"Content\Sponsors\physquirrel.png", content, gl);
            Add(sponsors1, "P. S.", @"Content\Sponsors\borb.png", content, gl);
            Add(sponsors1, "A different P. S.", @"Content\Sponsors\pleasedfrog.png", content, gl);
            Add(sponsors1, "E. C.", @"Content\Sponsors\disturbingkoala.png", content, gl);
            Add(sponsors1, "L. K. L.", @"Content\Sponsors\bork.png", content, gl);
            Add(sponsors1, "A. L.", @"Content\Sponsors\waryoctopus.png", content, gl);
            Add(sponsors1, "D. P.", @"Content\Sponsors\contentsluginthevoid.png", content, gl);
            Add(sponsors1, "Creative-House.org", @"Content\Sponsors\handicat.png", content, gl);
            Add(sponsors1, "vietnt", @"Content\Sponsors\raisondetre.png", content, gl);
            Add(sponsors1, "demiurghg", @"Content\Sponsors\ifiwereatardigrade.png", content, gl);
            Add(sponsors1, "JohnGert", @"Content\Sponsors\bedtimeforopossum.png", content, gl);
            Add(sponsors1, "Claytonious", @"Content\Sponsors\beaverboss.png", content, gl);
            Add(sponsors1, "Damian", @"Content\Sponsors\marmottourism.png", content, gl);
            ...
            Add(sponsors2, @"M. T.", @"Content\Sponsors\goose.png", content, gl);
            Add(sponsors2, @"Yo Mamma wants you to go to bed", @"Content\Sponsors\spide.png", content, gl);
            Add(sponsors2, @"A. R.", @"Content\Sponsors\scootybun.png", content, gl);
            Add(sponsors2, @"Alex 'mcmonkey' Goodwin, @mcmonkey4eva on github and twitter", @"Content\Sponsors\mcmonkey.png", content, gl);
            Add(sponsors2, @"A. K. D.", @"Content\Sponsors\behattedpenguin.png", content, gl);
            Add(sponsors2, @"Cornmaiden xoxoxo", @"Content\Sponsors\healthyostrich.png", content, gl);
            Add(sponsors2, @"F.", @"Content\Sponsors\tootbush.png", content, gl);
            Add(sponsors2, "G. T.", @"Content\Sponsors\ladybugwouldpreferlandvaluetax.png", content, gl);
            ...
            Add(sponsors3, @"Neos VR", @"Content\Sponsors\spooky.png", content, gl);
        ...
        public override void Render(Renderer renderer, Camera camera, Input input, TextBuilder text, Font font)
        {
            ...
            var integerResolution = renderer.Resolution;
            ...
            DrawSponsors("Sponsors", sponsors1, new Vector2(renderer.Resolution.X - 512, resolution.Y - 480), mousePosition, renderer, text, font, realTime, 4, 4, 0.25f, 24, 4, 36);
            DrawSponsors("Smaller sponsors who are still cool", sponsors0, new Vector2(renderer.Resolution.X - 512, resolution.Y - 288), renderer, text, font, realTime, 4, 4, 0.25f, 16, 24);
