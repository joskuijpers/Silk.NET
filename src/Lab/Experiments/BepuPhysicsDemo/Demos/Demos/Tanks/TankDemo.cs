...
namespace Demos.Demos.Tanks
{
    public class TankDemo : Demo
    {
        ...
        public override void Render(Renderer renderer, Camera camera, Input input, TextBuilder text, Font font)
        {
            ...
            var textHeight = 16;
            var position = new Vector2(32, renderer.Resolution.Y - 144);
            ...
            if (aiTanks.Count > 0)
                renderer.TextBatcher.Write(text.Clear().Append("Enemy tanks remaining: ").Append(aiTanks.Count), new Vector2(32, renderer.Resolution.Y - 172), 24, new Vector3(1, 1, 1), font);
            else
                renderer.TextBatcher.Write(text.Clear().Append("ya did it!"), new Vector2(32, renderer.Resolution.Y - 172), 24, new Vector3(0.3f, 1, 0.3f), font);
