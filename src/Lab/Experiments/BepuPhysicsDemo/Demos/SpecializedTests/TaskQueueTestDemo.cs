    ...
    public override void Initialize(ContentArchive content, Camera camera)
    {
        ...
        for (int i = 0; i < 10; ++i)
        {
            ...
            Test(() =>
            {
                ...
                var continuation = linkedTaskStackPointer->AllocateContinuation(iterationCount * tasksPerIteration, 0, ThreadDispatcher, new BepuUtilities.TaskScheduling.Task(&IssueStop<TaskStack>, &context));
