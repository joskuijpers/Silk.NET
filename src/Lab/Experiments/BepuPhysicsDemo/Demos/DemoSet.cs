...
namespace Demos
{
    ...
    public class DemoSet
    {
        ...
        {
            public string Name;
            public Func<ContentArchive, Camera, GL, Demo> Builder;
        }
        ...
        public Demo Build(int index, ContentArchive content, Camera camera, GL gl)
        {
            return options[index].Builder(content, camera, gl);
        }
    }
}
